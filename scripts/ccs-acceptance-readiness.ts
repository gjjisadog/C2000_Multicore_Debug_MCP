...
try {
  ...
  assertToolContract(contracts, "c2000_launchAndRunIpcAcceptance", "launch", "launch-workflow", ["cpu1CoreId", "cpu2CoreId", "cpu1OutPath", "cpu2OutPath", "timeoutMs"], ["launch.coreMap[].coreId", "launch.created.cores[].coreId", "launch.connected.results[].coreId", "snapshot.cores[].coreId", "ipcReady.conditions[].coreId", "diagnosis.cpu1.coreId", "diagnosis.cpu2.coreId", "diagnosis.snapshot.cores[].coreId", "ramOwnership.maps[].coreId"]);
  assertToolContract(contracts, "c2000_runIpcAcceptance", "launch", "launch-workflow", ["sessionId", "cpu1CoreId", "cpu2CoreId", "cpu1OutPath", "cpu2OutPath", "timeoutMs"], ["snapshot.cores[].coreId", "ipcReady.conditions[].coreId", "diagnosis.cpu1.coreId", "diagnosis.cpu2.coreId", "diagnosis.snapshot.cores[].coreId", "ramOwnership.maps[].coreId"]);
  assertToolContract(contracts, "c2000_runResidentIpcDebug", "launch", "launch-workflow", ["sessionId", "cpu1CoreId", "cpu2CoreId"], ["snapshot.cores[].coreId", "ipcReady.conditions[].coreId", "applicationEntry.coreId", "diagnosis.cpu1.coreId", "diagnosis.cpu2.coreId", "diagnosis.snapshot.cores[].coreId", "ramOwnership.maps[].coreId"]);
  assertToolContract(contracts, "c2000_launchResidentIpcDebug", "launch", "launch-workflow", ["cpu1OutPath", "cpu2OutPath"], ["launch.coreMap[].coreId", "launch.created.cores[].coreId", "launch.connected.results[].coreId", "snapshot.cores[].coreId", "ipcReady.conditions[].coreId", "applicationEntry.coreId", "diagnosis.cpu1.coreId", "diagnosis.cpu2.coreId", "diagnosis.snapshot.cores[].coreId", "ramOwnership.maps[].coreId"]);
  ...
  assertToolContract(contracts, "c2000_runFullDebugBundle", "launch", "launch-workflow", ["sessionId", "cpu1CoreId", "cpu2CoreId"], ["snapshot.cores[].coreId", "loadedPrograms[].coreId", "expressions[].coreId", "pc[].coreId", "ramOwnership.maps[].coreId", "bootHandoff.cpu1.coreId", "bootHandoff.cpu2.coreId"]);
