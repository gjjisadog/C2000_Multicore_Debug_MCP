export type DebugErrorCode =
  ...
  | "BoardQuarantined"
  | "PowerCyclePending"
  | "PowerCycleUnavailable"
  | "PowerCycleRequiresDaemon"
  | "PowerCycleBusy"
  | "PowerCycleSessionUnsafe"
  | "PowerCycleSessionCloseFailed"
  | "PowerCycleFlashIncomplete"
  | "PowerCycleFlashUnverified"
  | "PowerCycleConfirmationInvalid"
  | "PowerCycleMcpFailed"
  | "PowerCycleMcpInvalid"
  | "BoardLeased"
  ...
  | "Cpu1OnlyResetRequired"
  | "ApplicationEntryNotConfigured"
  | "ApplicationEntryNotReached"
  ...
  | "EradCounterInvalid"
  | "EradSysclkInvalid"
  | "ClaTimingDeviceUnsupported"
  | "ClaTimingRequestInvalid"
  | "ClaTimingTaskMismatch"
  | "ClaTimingSnapshotUnstable"
  | "ClaTimingRecordSymbolNotFound"
  | "ClaTimingRecordInvalid"
