...
export const c2000ToolDefinitions: ToolDefinition[] = [
  ...
  { name: "c2000_launchAndRunIpcAcceptance", title: "Launch And Run C2000 IPC Acceptance", description: "Create and connect an explicit CPU1/CPU2 session, run the full IPC acceptance workflow inside the MCP server with one client approval, and optionally reclaim the created session after it becomes idle.", schema: launchAndRunIpcAcceptanceSchema, handlerName: "launchAndRunIpcAcceptance", inputScope: "launch", targetEffect: "launch-workflow", coreIdentityFields: ["cpu1CoreId", "cpu2CoreId", "ipcReadyExpressions[].coreId"], responseCoreIdentityFields: [...launchAndRunIpcAcceptanceResponseIdentity] },
